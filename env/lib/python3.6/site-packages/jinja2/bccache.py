...
class FileSystemBytecodeCache(BytecodeCache):
    ...
    Windows the user's main directory is used, on UNIX systems a directory
    is created for the user in the system main directory.
    ...
    def _get_default_cache_dir(self) -> str:
        def _unsafe_dir() -> "te.NoReturn":
            raise RuntimeError(
                "Cannot determine safe main directory.  You "
